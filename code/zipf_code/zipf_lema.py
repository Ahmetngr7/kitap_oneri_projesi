...
# Lemmatize edilmiş veriler için CSV dosyasını oku
df = pd.read_csv('ciktilar/csv_dosyalari/lema_sonuclar.csv')
...
if not en_yaygin:
    ...
    plt.ylabel("Frekans")
    plt.title("Zipf Yasası - Lemmatize Edilmiş Veri")
    plt.grid(True)
    plt.tight_layout()
    plt.savefig("ciktilar/zipf_dosyaları/grafikler/zipf_lema_loglog.png")
    plt.close()
